...
export default class BetCircular extends React.Component {
	constructor() {
		...
		this.reScale = (_, active = this.state.active) => {
			//第一个参数留空是避免被window event listener塞对象进去
	...
	render() {
		var o = { opacity: this.state.init ? "" : 0 },
		    svgStyle = [_extends({}, o), _extends({}, o)];
		...
		return React.createElement(
			...
			React.createElement(LeftRotateSVG, { id: "left-rotate", onClick: () => this.chooseDirect(-1), style: svgStyle[0] }),
			React.createElement(RightRotateSVG, { id: "right-rotate", onClick: () => this.chooseDirect(1), style: svgStyle[1] }),
			React.createElement(
				"div",
				{ className: "circ" },
				React.createElement(
					...
					this.ul.map((item, index) => {
						var a;
						if (item != 0) a = React.createElement(
							"a",
							null,
							item
						);else a = React.createElement(
							"a",
							null,
							React.createElement(
								"small",
